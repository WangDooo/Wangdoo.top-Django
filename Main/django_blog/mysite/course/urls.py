...
from .views import CourseListView, ManageCourseListView, CreateCourseView, DeleteCourseView, CreateLessonView, ListLessonsView
from .views import DetailLessonView, StudentListLessonView
app_name = 'course'
urlpatterns = [
